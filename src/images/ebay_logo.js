...
const EbayLogo = ({ baseLayer, color0, color1, color2, color3 }) => (
  <svg
    version="1.1"
    className={baseLayer}
    x="0px"
    y="0px"
    viewBox="0 0 300 120.3"
  >
    <path
      id="e"
      className={color0}
      d="M38.9,26.3c-21.1,0-38.8,9-38.8,36c0,21.4,11.8,34.9,39.3,34.9C71.7,97.3,73.8,76,73.8,76H58.1
    ...
    <path
      id="b"
      className={color1}
      d="M75.4,0.1v83.6c0,4.7-0.3,11.4-0.3,11.4H90c0,0,0.5-4.8,0.5-9.2c0,0,7.4,11.5,27.5,11.5
    ...
    <path
      id="a"
      className={color2}
      d="M190.6,26.3c-31.8,0-33.9,17.4-33.9,20.2h15.8c0,0,0.8-10.2,16.9-10.2c10.5,0,18.6,4.8,18.6,14v3.3
    ...
    <path
      id="y"
      className={color3}
      d="M214.9,29h17.8l25.6,51.2L283.8,29h16.1l-46.5,91.2h-16.9l13.4-25.4L214.9,29z"
    />
  </svg>
)
